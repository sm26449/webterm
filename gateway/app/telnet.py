...
class OscFilter:
    ...
    def _emit_osc(self, out: bytearray, terminator: bytes) -> None:
        ...
        # …şi spaţii: `int(b" 52")` e 52 pentru xterm, dar `b" 52".isdigit()` e False, deci un
        # device ostil putea trece filtrul cu `ESC ] «spaţiu»52 ;`. Azi nu e exploatabil
        # (frontend-ul nu înregistrează handler OSC 52), dar filtrul nu trebuie să depindă
        # de ce NU implementează clientul.
        ident = ident.strip()
        if ident.isdigit():
