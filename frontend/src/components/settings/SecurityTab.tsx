...
// Securitate: dispozitive conectate, cheia de semnare a flotei, passkeys, 2FA (TOTP), token-uri de
// automatizare, token-uri de înrolare de grup şi guardrail-ul de comenzi. Extras din SettingsModal
...
export default function SecurityTab(props: { webauthnAvailable: boolean; onAccountChanged: () => void }) {
  ...
  // tot ce ţine de securitate se încarcă la montarea tab-ului (= la deschiderea secţiunii)
  useEffect(() => {
    load()
    loadTotp()
    loadSigning()
