...
[![Version](https://img.shields.io/badge/version-v2.0.6-blue)](https://github.com/sm26449/webterm/tags)
...
cd webterm
git checkout v2.0.6          # a tag cannot move under you; a branch can
...
with a recorded rollback point: `./deploy.sh v2.0.6` — if the new container does
