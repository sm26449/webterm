...
CI_TESTS="agent_hardening agent_reliability agent_tmux_hygiene ed25519_kat
          ...
          audit_2026_07 i18n_catalog route_auth audit_reads agent_flood attach_alert account_confirm csrf_ratelimit cert_pin web_sessions webauthn agent_uninstall resync_flush"
